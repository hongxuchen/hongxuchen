...
\section{工作经历}
\cventry{2020.10至今}{华为}{主任工程师}{}{}{通过\href{https://career.huawei.com/reccampportal/portal5/topminds.html}{天才少年招聘}加入华为新加坡研究所，于2021年7月调回可信实验室(深圳)，主要从事下面工作。
\begin{enumerate}
	...
	\item 基于前述TENET工作，进行\textit{代码分析的数字化服务}项目研究，完成C/C++、Java、ArkTS的代码图谱的设计和实现。在技术上攻关单仓3000w+的C/C++源代码级精准分析能力。该项目已孵化形成~{\ding{172}}代码质量度量和架构异味识别引擎用于Clean Code L3的\textit{IDE级}和\textit{版本级}检查平台CleanArch，并结合代码图谱信息、缺陷检查规则和LLM完成智能化重构辅助，该能力落地于公司13个产业的80+个业务；~{\ding{173}}基于代码图谱和LLM的精准代码文档生成和智能问答的Web端类deepwiki服务，已完成对公司内410+存量代码仓的分析。
...
\cventry{2019.08-2020.9}{南洋理工大学}{Research Fellow}{}{}{扩展了自研模糊测试框架FOT, 项目主页\url{https://sites.google.com/view/fot-the-fuzzer}，{\ding{172}}增强了其对结构化输入的支持，提升了测试用例生成的合法性；{\ding{173}}对多线程分析场景下提供了模糊测试方案MUZZ，提升了非顺序执行场景下的模糊测试有效性。同时进行的项目包括高性能跨CPU二进制模糊测试框架BiFF，完成了在ARM、x86及RISCV下仅二进制场景下的高效fuzz，相关工作已落地Continental(马牌轮胎)渗透测试。 }
...
\cvlistitem{软件安全: 从事对C/C++程序进行模糊测试的研究, 主要思路为利用静态程序分析的方法来提高模糊测试的有效性和优效性。}
